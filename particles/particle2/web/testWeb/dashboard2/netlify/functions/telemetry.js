...
function normalizeSheetRow(row) {
  return {
    ...
    pdgcOverride0a: numberValue(row, ["pdgcOverride0a", "pdgc_override_service_0a"]),
    pdgcOverride03: numberValue(row, ["pdgcOverride03", "pdgc_override_service_03"]),
    ...
    rectifierSensorError: numberValue(row, ["rectifierSensorError", "CAN_RectifierSensorError"]),
    ptoLatchedOpen: numberValue(row, ["ptoLatchedOpen", "CAN_PtoLatchedOpen"]),
    ...
    generatorSensorError: numberValue(row, ["generatorSensorError", "CAN_GeneratorSensorError"]),
    doorInterlock: numberValue(row, ["doorInterlock", "CAN_DoorInterlock"]),
    pumpFrozen: numberValue(row, ["pumpFrozen", "Log_PumpFrozen"]),
    prechargeTimeout: numberValue(row, ["prechargeTimeout", "Log_PrechargeTimeout"]),
    mcuStartupStatus: numberValue(row, ["mcuStartupStatus", "Log_McuStartupStatus"]),
    mcuHeartbeat: numberValue(row, ["mcuHeartbeat", "Log_McuHeartbeat"]),
    ...
    startPrecharge: numberValue(row, ["startPrecharge", "MFSM_StartPrecharge"]),
    restartRequest: numberValue(row, ["restartRequest", "MFSM_RestartRequest"]),
    ignoreErrors: numberValue(row, ["ignoreErrors", "MFSM_IgnoreErrors"]),
    closePosContact: numberValue(row, ["closePosContact", "MFSM_ClosePosContact"]),
    closeNegContact: numberValue(row, ["closeNegContact", "MFSM_CloseNegContact"]),
    torqueRefPercent: numberValue(row, ["torqueRefPercent", "Log_TorqueRefPercent"]),
