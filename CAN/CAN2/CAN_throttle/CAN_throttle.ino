...
float appMax = 78.8f;//80.4
float volOut = 0.0f;

// Prevent tiny noise from constantly changing min/max
const float APP_EPSILON = 0.15f;
...
void loop() {
  ...
  if (now - lastPrintMs >= 200) {
    ...
    //Serial.println("L/h");
    Serial.print("  Vo:"); Serial.print(volOut,2);
    Serial.print("  MIN:"); Serial.print(appMin, 2);
    Serial.print("  MAX:"); Serial.print(appMax, 2);
    Serial.print("  APP:"); if(seen49) Serial.println(app,1); else Serial.println("-");
  }
}
